...
export default {
  ...
  getters: {
    ...
    skyIdTokensBySub: (state, { tokensByType }) => tokensByType.skyId || {},
    mySkyTokensBySub: (state, { tokensByType }) => tokensByType.mySky || {},
  ...
  actions: {
    ...
    addSkyIdToken: tokenAdder('skyId'),
    addMySkyToken: tokenAdder('mySky'),
